...
@Sql(scripts = {
        "classpath:database/books/remove-books-categories.sql",
...
public class BookRepositoryTest {
    ...
    @Test
    @DisplayName("Find all books by correct categories id")
    ...
    @Test
    @DisplayName("Find all books by incorrect categories id")
